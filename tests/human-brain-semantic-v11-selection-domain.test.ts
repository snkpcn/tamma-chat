...
test('semantic-v26 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v26 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
