...
test('semantic-v12 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v12 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
