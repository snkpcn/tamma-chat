...
test('semantic-v17 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v17 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
