...
test('semantic-v25 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v25 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
