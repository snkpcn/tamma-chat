...
test('semantic-v27 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v27 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
