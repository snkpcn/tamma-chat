...
test('semantic-v11 doctrine locks selection-with-slots and explicit category domain ownership',()=>{
...
test('semantic-v11 keeps both completed-v10 first-chunk gold labels unchanged',()=>{
