...
test('semantic-v10 version is explicit',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v10');
});

test('semantic-v10 doctrine separates the boundary pairs exposed by full semantic-v8 live certification',()=>{
...
test('semantic-v10 honestly adjudicates one contradictory modify gold and preserves the other live-v8 golds',()=>{
