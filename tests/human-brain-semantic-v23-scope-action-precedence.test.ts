...
test('semantic-v27 preserves the three v22 live-failure gold meanings',()=>{
...
test('semantic-v27 decides broad scope before answer type without lexical category guessing',()=>{
...
test('semantic-v27 makes evaluative guidance outrank catalog browsing after scope is chosen',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
