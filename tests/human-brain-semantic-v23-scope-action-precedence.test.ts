...
test('semantic-v26 preserves the three v22 live-failure gold meanings',()=>{
...
test('semantic-v26 decides broad scope before answer type without lexical category guessing',()=>{
...
test('semantic-v26 makes evaluative guidance outrank catalog browsing after scope is chosen',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
