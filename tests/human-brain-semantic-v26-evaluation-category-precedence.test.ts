...
test('semantic-v26 preserves the four semantic-v25 live-failure boundary gold meanings',()=>{
...
test('semantic-v26 preserves inherent evaluation after contextual metadata is removed',()=>{
...
test('semantic-v26 resolves an explicit category noun before venue framing or generic predicates',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
