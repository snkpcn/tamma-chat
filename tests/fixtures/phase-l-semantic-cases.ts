...
export const PHASE_L_SEMANTIC_CASES:SemanticEvalCase[]=[
  ...
  c('l-activity-01','formal','activity','ราคาขี่ม้าตอนนี้เท่าไหร่ครับ','ask','ask_horse_price',{activityType:'horse'},undefined,[],false,'price'),
  c('l-activity-02','formal','activity','เด็ก 7 ขวบขี่ม้าได้ไหม','ask','ask_horse_child_policy',{activityType:'horse',childAge:7},undefined,[],false,'policy'),
  ...
  c('l-activity-04','colloquial','activity','ไม่เคยยิงธนูเลย เล่นได้ปะ','ask','ask_archery_beginner',{activityType:'archery'},undefined,['beginner'],false,'policy'),
  ...
  c('l-restaurant-02','formal','restaurant','มากันสองคน งบ 500 แนะนำให้หน่อย','recommend','recommend_for_budget',{partySize:2,budget:500},RESTAURANT_CONTEXT,[],false,'recommendation'),
  c('l-restaurant-03','colloquial','restaurant','ไม่กินหมู เอาอะไรดี','recommend','recommend_without_pork',{},undefined,['no_pork'],false,'recommendation'),
  ...
  c('l-stay-01','formal','stay','เช็กอินได้ตั้งแต่กี่โมง','ask','ask_checkin_time',{},undefined,[],false,'schedule'),
  c('l-stay-02','typo','stay','เช็คเอ้าท์กี่โมงคับ','ask','ask_checkout_time',{},undefined,[],false,'schedule'),
