...
export const PHASE_L_SEMANTIC_CASES:SemanticEvalCase[]=[
  ...
  c('l-member-04','formal','membership','ขอเปลี่ยนข้อมูลสมาชิกได้ไหม','ask','ask_membership_change_policy',{},undefined,[],false,'policy'),
  ...
  c('l-journey-09','multi_intent','activity','มีอะไรทำแล้วไปกินข้าวต่อได้พอดี','recommend','recommend_activity_then_meal',{},undefined,['before_meal'],false,'recommendation'),
