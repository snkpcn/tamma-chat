...
test('semantic-v26 preserves both remaining v21 full-cert gold meanings',()=>{
...
test('semantic-v26 makes topic-only subject inquiries clarify instead of browsing',()=>{
...
test('semantic-v26 keeps generic cross-business flow as journey composition',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
