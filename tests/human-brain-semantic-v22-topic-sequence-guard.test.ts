...
test('semantic-v28 preserves both remaining v21 full-cert gold meanings',()=>{
...
test('semantic-v28 makes topic-only subject inquiries clarify instead of browsing',()=>{
...
test('semantic-v28 keeps generic cross-business flow as journey composition',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
