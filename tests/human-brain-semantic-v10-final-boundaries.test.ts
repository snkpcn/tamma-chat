...
test('semantic-v25 doctrine locks the remaining live human-meaning boundaries',()=>{
...
test('semantic-v25 keeps seven model-wrong golds unchanged and honestly adjudicates two ambiguous golds',()=>{
