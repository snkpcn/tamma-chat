...
test('semantic-v21 doctrine locks the remaining live human-meaning boundaries',()=>{
...
test('semantic-v21 keeps seven model-wrong golds unchanged and honestly adjudicates two ambiguous golds',()=>{
