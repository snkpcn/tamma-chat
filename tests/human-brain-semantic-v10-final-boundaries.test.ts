...
test('semantic-v24 doctrine locks the remaining live human-meaning boundaries',()=>{
...
test('semantic-v24 keeps seven model-wrong golds unchanged and honestly adjudicates two ambiguous golds',()=>{
