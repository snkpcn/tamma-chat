...
test('semantic-v15 doctrine locks the remaining live human-meaning boundaries',()=>{
...
test('semantic-v15 keeps seven model-wrong golds unchanged and honestly adjudicates two ambiguous golds',()=>{
