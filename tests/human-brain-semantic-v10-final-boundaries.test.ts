...
test('semantic-v11 doctrine locks the remaining live human-meaning boundaries',()=>{
...
test('semantic-v11 keeps seven model-wrong golds unchanged and honestly adjudicates two ambiguous golds',()=>{
