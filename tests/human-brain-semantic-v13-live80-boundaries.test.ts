...
test('semantic-v23 keeps all five v12 live gold labels unchanged',()=>{
...
test('semantic-v23 prompt distinguishes availability, identity, save-plan, permission, and venue-domain boundaries',()=>{
...
test('semantic-v23 structurally normalizes modify+policy into a read-only ask',()=>{
