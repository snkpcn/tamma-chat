...
test('semantic-v19 keeps all five v12 live gold labels unchanged',()=>{
...
test('semantic-v19 prompt distinguishes availability, identity, save-plan, permission, and venue-domain boundaries',()=>{
...
test('semantic-v19 structurally normalizes modify+policy into a read-only ask',()=>{
