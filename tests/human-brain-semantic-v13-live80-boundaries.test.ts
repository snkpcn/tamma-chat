...
test('semantic-v21 keeps all five v12 live gold labels unchanged',()=>{
...
test('semantic-v21 prompt distinguishes availability, identity, save-plan, permission, and venue-domain boundaries',()=>{
...
test('semantic-v21 structurally normalizes modify+policy into a read-only ask',()=>{
