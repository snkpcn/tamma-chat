...
test('semantic-v17 version is explicit so live certification cannot inherit semantic-v7 results',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v17');
});

test('semantic-v17 doctrine locks the eight human-meaning boundaries from completed live v7 certification',()=>{
...
test('semantic-v17 keeps the adjudicated live-v7 gold labels unchanged',()=>{
