...
test('semantic-v18 version is explicit so live certification cannot inherit semantic-v7 results',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v18');
});

test('semantic-v18 doctrine locks the eight human-meaning boundaries from completed live v7 certification',()=>{
...
test('semantic-v18 keeps the adjudicated live-v7 gold labels unchanged',()=>{
