...
test('semantic-v26 preserves the two remaining v23 gold meanings',()=>{
...
test('semantic-v26 treats generic action predicates as broad ecosystem scope',()=>{
...
test('semantic-v26 does not turn companion context into evaluation by itself',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
