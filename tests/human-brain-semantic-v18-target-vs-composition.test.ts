...
test('semantic-v21 keeps both remaining v17 full-cert golds unchanged',()=>{
...
test('semantic-v21 decides single requested target before incidental sequence language',()=>{
...
test('semantic-v21 makes journey composition recommend and reserves discover for existing journey catalogs',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
