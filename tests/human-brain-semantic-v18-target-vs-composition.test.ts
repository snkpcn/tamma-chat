...
test('semantic-v19 keeps both remaining v17 full-cert golds unchanged',()=>{
...
test('semantic-v19 decides single requested target before incidental sequence language',()=>{
...
test('semantic-v19 makes journey composition recommend and reserves discover for existing journey catalogs',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
