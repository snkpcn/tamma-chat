...
test('semantic-v26 keeps both remaining v17 full-cert golds unchanged',()=>{
...
test('semantic-v26 decides single requested target before incidental sequence language',()=>{
...
test('semantic-v26 makes journey composition recommend and reserves discover for existing journey catalogs',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
