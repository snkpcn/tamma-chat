...
test('semantic-v27 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v27');
});

test('semantic-v27 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v27 keeps informational-02 gold unchanged',()=>{
