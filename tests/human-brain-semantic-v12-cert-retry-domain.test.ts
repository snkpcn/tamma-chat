...
test('semantic-v25 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v25');
});

test('semantic-v25 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v25 keeps informational-02 gold unchanged',()=>{
