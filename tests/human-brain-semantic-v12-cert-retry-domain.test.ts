...
test('semantic-v22 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v22');
});

test('semantic-v22 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v22 keeps informational-02 gold unchanged',()=>{
