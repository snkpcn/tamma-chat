...
test('semantic-v17 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v17');
});

test('semantic-v17 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v17 keeps informational-02 gold unchanged',()=>{
