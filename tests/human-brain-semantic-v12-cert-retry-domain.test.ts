...
test('semantic-v20 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v20');
});

test('semantic-v20 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v20 keeps informational-02 gold unchanged',()=>{
