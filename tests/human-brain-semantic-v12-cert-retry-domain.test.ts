...
test('semantic-v19 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v19');
});

test('semantic-v19 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v19 keeps informational-02 gold unchanged',()=>{
