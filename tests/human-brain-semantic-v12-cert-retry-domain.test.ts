...
test('semantic-v16 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v16');
});

test('semantic-v16 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v16 keeps informational-02 gold unchanged',()=>{
