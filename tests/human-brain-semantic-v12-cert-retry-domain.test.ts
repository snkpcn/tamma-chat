...
test('semantic-v26 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v26');
});

test('semantic-v26 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v26 keeps informational-02 gold unchanged',()=>{
