...
test('semantic-v24 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v24');
});

test('semantic-v24 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v24 keeps informational-02 gold unchanged',()=>{
