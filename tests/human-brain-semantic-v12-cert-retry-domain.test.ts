...
test('semantic-v18 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v18');
});

test('semantic-v18 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v18 keeps informational-02 gold unchanged',()=>{
