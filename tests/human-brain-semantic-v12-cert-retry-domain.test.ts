...
test('semantic-v23 version is explicit so v11 partial evidence cannot be resumed',()=>{
  assert.equal(SEMANTIC_INTERPRETER_VERSION,'semantic-v23');
});

test('semantic-v23 makes an explicitly requested single business catalog own the domain',()=>{
...
test('semantic-v23 keeps informational-02 gold unchanged',()=>{
