...
test('semantic-v19 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v19 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v19 final precedence separates broad browsing from evaluative choosing',()=>{
