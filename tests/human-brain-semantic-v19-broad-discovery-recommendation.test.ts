...
test('semantic-v22 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v22 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v22 final precedence separates broad browsing from evaluative choosing',()=>{
