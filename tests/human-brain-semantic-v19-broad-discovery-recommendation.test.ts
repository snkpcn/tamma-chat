...
test('semantic-v20 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v20 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v20 final precedence separates broad browsing from evaluative choosing',()=>{
