...
test('semantic-v24 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v24 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v24 final precedence separates broad browsing from evaluative choosing',()=>{
