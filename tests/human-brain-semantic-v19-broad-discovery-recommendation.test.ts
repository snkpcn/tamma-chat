...
test('semantic-v23 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v23 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v23 final precedence separates broad browsing from evaluative choosing',()=>{
