...
test('semantic-v26 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v26 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v26 final precedence separates broad browsing from evaluative choosing',()=>{
