...
test('semantic-v21 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v21 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v21 final precedence separates broad browsing from evaluative choosing',()=>{
