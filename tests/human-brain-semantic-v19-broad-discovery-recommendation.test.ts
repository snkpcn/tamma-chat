...
test('semantic-v25 honestly adjudicates evaluative broad requests as recommendation',()=>{
...
test('semantic-v25 keeps bare discovery with companion context as discovery',()=>{
...
test('semantic-v25 final precedence separates broad browsing from evaluative choosing',()=>{
