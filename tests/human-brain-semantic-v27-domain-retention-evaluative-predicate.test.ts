...
test('semantic-v27 preserves all semantic-v26 chunk-one failure gold meanings',()=>{
...
test('semantic-v27 keeps recognizable business domains when record identity is missing',()=>{
...
test('semantic-v27 treats embedded qualitative judgment as recommendation',()=>{
  const p=buildSemanticInterpreterPrompt(emptySemanticContext()).replace(/\s+/g,' ');
