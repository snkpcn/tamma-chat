...
- If the customer wants one primary activity that should fit before or after a meal, stay, or other event, keep activity even when phrased generically as something to do. The later or earlier event is only a timing or sequencing anchor unless the customer asks you to choose, arrange, or coordinate that event too. Use journey only when the multi-part sequence itself is the requested deliverable.
