...
- Use modify for a requested change to an already selected concrete item, slot, schedule, or plan. For those concrete preference/choice adjustments, dissatisfaction plus a requested new value is modify, not correct_previous. Reserve correct_previous for explicit claims that the earlier value/statement itself was mistaken or wrong.
